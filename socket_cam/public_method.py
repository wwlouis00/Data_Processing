...
def initialize():
    ...
    if not os.path.isdir('./para/result'):
        print("Directory './para/result' does not exist.")
        os.mkdir('./para/result')
        print("Directory './para/result' is established.")
...
def write_to_csv(filename, data):
    ...
    :return None:
    """
    if filename == './para/tmp/cali_factor.csv' or filename == './para/ROIs/coordinates.csv':
